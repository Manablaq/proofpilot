...
console.log(`Submitted ProofPilot V9 deployment: ${explorer}/tx/${deployTransactionHash}`)
...
if (receipt.txExecutionResultName !== 'FINISHED_WITH_RETURN') {
  throw new Error(`V9 deployment did not execute successfully: ${receipt.txExecutionResultName ?? 'UNKNOWN'}. Do not configure the frontend or redeploy blindly.`)
}
...
console.log(JSON.stringify({
  release: 'V9', deployTransactionHash, contractAddress, listCampaigns: campaigns,
